...
class BrowseEvents extends StatelessWidget {
  ...
  final cardLeft =
      Column(crossAxisAlignment: CrossAxisAlignment.start, //left-aligned
        ...
        Container(
            ...
            child: const Text('1234 W Sample St, Vancouver, BC',
                style: TextStyle(
                    fontSize: 12,
        ...
        Container(
            ...
            child: const Text('6:00pm - 11:00pm',
                style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w300,
                    fontStyle: FontStyle.italic))),
        Container(
            ...
            child: const Text('Celebrating Martha\'s 75th birthday',
  ...
  final cardRight =
      Column(crossAxisAlignment: CrossAxisAlignment.center, //left-aligned
          children: [
        Container(
            child: const Text(
          'NOV',
