...
import 'package:auth_frontend/browse_events.dart';
...
class NavDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    // Menu items
    return Drawer(
      child: Material( // Use material instead of container so it's clickable?
        child: ListView(
          padding: padding,
          children: <Widget>[
            // main menu items
            ...
            buildMenuItem(
              text: 'Create Event',
              icon: Icons.add,
              onClicked: () => selectedItem(context, 1) //uncomment when the page has been created
            ),
            const SizedBox(height: 16,),
            buildMenuItem(
              text: 'My Events',
  ...
  void selectedItem(BuildContext context, int index){
    ...
    switch(index){
      case 0:
        ...
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => BrowseEvents()));
        break;
      case 1:
      ...
      //   break;
      case 6:
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => LoginPage(title: 'Log in')));
        break;
